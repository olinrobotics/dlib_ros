...
if("TRUE" STREQUAL "TRUE")
  set(dlib_SOURCE_PREFIX /home/sophianielsen/catkin_ws/dlib)
  set(dlib_DEVEL_PREFIX /home/sophianielsen/catkin_ws/dlib/cmake-build-debug/devel)
  set(dlib_INSTALL_PREFIX "")
  set(dlib_PREFIX ${dlib_DEVEL_PREFIX})
else()
  set(dlib_SOURCE_PREFIX "")
  set(dlib_DEVEL_PREFIX "")
  set(dlib_INSTALL_PREFIX /usr/local)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'dlib' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'sophianielsen <sophianielsen221b@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'dlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sophianielsen/catkin_ws/dlib/${idir}'.  Ask the maintainer 'sophianielsen <sophianielsen221b@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sophianielsen/catkin_ws/dlib/cmake-build-debug/devel/lib;/home/sophianielsen/catkin_ws/devel/lib;/opt/ros/indigo/lib)
